...
export interface LedgerAccountRetrieveResponse {
     ...
     */
    ledger_account_audit_status: 'pending' | 'approved' | 'reserves_imposed' | 'suspended' | 'ignored' | 'rejected' | 'requested_more_information' | 'information_submitted' | 'requested_tos_violation_correction' | 'clawback_attempted' | 'awaiting_sales_review' | null;
    /**
